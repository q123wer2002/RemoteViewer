define([
	...
	function cncOffset($scope,$http,$interval,$timeout,$rootScope,frontendAdaptor,commandMgr){
		...
		{
			//check agent version
			var isCorrectVersion = $scope.fnCheckAgentVersion( "OFFSET", "" );
		...
		$scope.fnIsShowPage = function( isUnitPage )
		{
		...
		//db connect
			DoCommand = function()
			{
				...
				commandMgr.fnSendCommand( "CMD", commandObj, this.fnGetResult, false, true );
			}
