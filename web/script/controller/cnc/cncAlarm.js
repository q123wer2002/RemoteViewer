define([
	...
	function cncAlaram($scope,$http,$interval,$timeout,$rootScope){
	...
	//Alarm
		...
		$scope.setAlmParam = function( unitKey )
		{
			...
			//check agent version
			var isCorrectVersion = $scope.fnCheckAgentVersion( "ALARM", unitKey );
		...
		$scope.fnIsShowPage = function( isUnitPage, szShowPage )
		{
			...
			if( $scope.curtAlmUnit == szShowPage ){
				return true;
			}
