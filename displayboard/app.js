...
define([
	...
	//value
	app.value( "MODE", "DISPLAYBOARD" );
	app.value( "PATH", { WEBPATH : "http://localhost:1234/RemoteViewer_AUTO850/displayboard/", SHAREDPATH : "http://localhost:1234/RemoteViewer_AUTO850/shared/"} );
	app.value( "VIEWERVERSION", "Beta 1.0.1" );

	//service
	
	//main controller
	app.controller("MainController", function($scope, $routeParams, accountMgr, cfgMgr, utilMgr, customMgr, cncDataMgr, MODE, PATH, VIEWERVERSION ){
